...
I split the data into equal sized testing and training data.  I used createDataParition, by passing the variable of interest to the y argument, the random samppling occurs within each class (Trump Wins/ Trump Doesnt Win) and should preserve the overall class distribution.  
